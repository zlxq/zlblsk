...
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/statics/frame/css/svg/graphical.css">
<script type="text/javascript"
	src="<%=request.getContextPath()%>/statics/frame/js/ui/jquery-ui-1.12.1.custom/external/jquery/jquery.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/statics/frame/js/ui/jquery-ui-1.12.1.custom/jquery-ui.min.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/statics/frame/js/ui/jquery-ui-1.12.1.custom/jquery-ui.js"></script>
	<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/statics/frame/js/ui/jquery-ui-1.12.1.custom/jquery-ui.css" />
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/statics/frame/js/ui/jquery-ui-1.12.1.custom/jquery-ui.structure.css"/>	
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/statics/frame/js/ui/jquery-ui-1.12.1.custom/jquery-ui.theme.css"/>	
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/statics/frame/js/ui/jquery-ui-1.12.1.custom/jquery-ui.min.css"/>
<script type="text/javascript"
...
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/statics/frame/js/colorpicker/colorpicker-master/jquery.colorpicker.css"/>	
<script type="text/javascript"
	src="<%=request.getContextPath()%>/statics/frame/js/colorpicker/colorpicker-master/jquery.colorpicker.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/statics/frame/js/colorpicker/colorpicker-master/parts/jquery.ui.colorpicker-rgbslider.js"></script>
<script type="text/javascript"
