...
<script type="text/javascript" src="<%=request.getContextPath()%>/statics/blsk/js/excel/xlsx.core.min.js"></script>
...
<body class="easyui-layout" style="overflow-y: hidden;" scroll="no">
	<div region="north" style="padding: 1px; background: #eee; overflow-y: hidden">
		...
		<table cellspacing="9">
	    	<tr>
	    	<td>表头行号：<input type="text" name="head_rownm" id="headInRow" nullmsg="请输入信息"/></td>
	    	...
	    	<tr>
	    	<td>选择文件：<input type="file" name="chooseFile" id="choosefile" nullmsg="请输入信息" onchange="read(this)" /></td>
