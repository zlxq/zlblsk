...
public class TemplateAction extends BaseAction {
	 ...
	 *
	 * @return
	 * @createtime 2019年5月28日
	 * @version V1.0
	 * @throws Exception 
	 */
	public String saveTemplate(){
		String data = this.getRequest().getParameter("data");
		String headInRow = this.getRequest().getParameter("headInRow");
	...
	public String getTemplate() {
		String json = this.blskTemplateMainService.getTemplate();
		setJsonString(json);
		return SUCCESS;
	}
